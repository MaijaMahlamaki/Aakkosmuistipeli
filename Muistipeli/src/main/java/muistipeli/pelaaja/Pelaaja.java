...
/**
 *Luokka tarjoaa metodeita pelaajan pisteiden laskemiseen 
 * ja pelin päätyttyä ilmestyvään viestiin.
 * 
 */
public class Pelaaja {
    ...
    /**
     * Pistelaskumetodi huolehtii pelaajan pisteiden kirjaamisesta.
     * Pistelasku menee niin, että löydetystä parista saa kaksi pistettä.
     * Jos paria ei löytynyt, pelaaja saa miinuspisteen.
     * Kahden parin löytämisestä peräkkäin saa kaksi bonuspistettä.
     * 
     * @param pisteet muistipelin välittämä pistemäärä, 
     * joka on joko 2 parin löytämisestä tai -1 hudista.
     * 
     */
    ...
    */
    ...
    /**
     *Metodissa määritellään viesti, jonka pelaaja saa pelin lopussa.
     *Viesti vaihtelee sen mukaan, kuinka hyvin pelaaja pärjäsi pelissä 
     *eli kerättyjen pisteiden ja bonuspisteiden mukaan.
     * 
     * @return 
    */
