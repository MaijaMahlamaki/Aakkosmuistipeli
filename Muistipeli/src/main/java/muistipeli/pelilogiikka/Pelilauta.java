...
/**
 * Luokka tarjoaa pelilautaan ja kortteihin liittyviä metodeita. Pelilauta
 * koostuu listasta korttiolioita.
 *
 */
 ...
 */
    ...
    /**
     * Metodi aloittaa uuden pelin luomalla kortit ja sekoittamalla niiden
     * järjestyksen.
     */
     ...
     * Kortteja on aina kaksi kohti jokaista kirjainta a-h. Näin muodostuu 16
     * paria, joista syntyy 4x4-kokoinen pelilauta.
     */
     ...
     * Pelilaudan korteilla on graafisessa käyttöliittymässä vain indeksit ja
     * tietoa kortin kirjaimesta säilytetään korttilistassa eli käännetyn kortin
     * kirjain noudetaan listasta tällä metodilla.
     *
    ...
    /**
     * Metodi poistaa parametrina annetut kortit pelilaudalta. Poistaminen
     * tapahtuu muuttamalla kyseisen kortin kirjain kirjaimeksi x (sillä
     * poistaminen listalta sekoittaisi indeksit ja korttien sijainnin
     * pelilaudalla).
     *
    ...
    /**
     * Metodi kertoo tekstikäyttöliittymää käytettäessä pelilaudalla olevien
     * korttien lukumäärän. Graafisessa käyttöliittymässä korttien lukumäärää
     * pelilaudalla ei ole tarvetta mainita, koska se on näkyvissä.
     *     
