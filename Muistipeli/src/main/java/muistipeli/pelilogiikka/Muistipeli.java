...
/**
 *Luokka tarjoaa metodeja varsinaiseen pelilogiikkaan: 
 * pelin aloittamiseen, parien tarkistamiseen ja pisteiden kirjaamiseen
 * sekä pelin päättymisen tarkistamiseen.
 * 
 */
...
/**
 * Metodi tarkistaa ovatko käännetyt kortit parit vai ei.
 * Parametreina ovat käännettyjen korttien indeksit. 
 * Palauttaa true, mikäli löytyi pari, muutoin false.
 * Poistaa löytyneet parit ja tällöin myös vähentää parien lukumäärää yhdellä.
 * Kirjaa pelaajan pisteet.
 * 
...
/**
 * Metodi "näyttää" pelaajalle käännetyt kortit eli
 * palauttaa sellaisenaan käyttökelpoisen merkkijonoesityksen,
 * jota voi hyödyntää käyttöliittymässä.
 *
 ...
 * Pisteet näkyvät koko pelin ajan käyttöliittymässä.
 * 
...
/**
 * Metodi tarkistaa, onko peli loppu.
 * Jos kaikki parit ovat löytyneet eli parien lukumäärä on nolla,
 * metodi palauttaa true, muutoin false.
 * 
 ...
 * Metodia tarvitaan vain tekstikäyttöliittymän kanssa, sillä
 * graafisessa käyttöliittymässä jäljellä olevien korttien lukumäärä
 * on nähtävillä koko ajan.
 * 
